...
def find_empty_dirs(root_path: str, follow_symlinks: bool = False) -> List[str]:
    ...
    try:
        ...
        for dirpath, dirnames, filenames in os.walk(
            root_path, topdown=False, followlinks=follow_symlinks
        ):
...
def remove_empty_dirs(
    empty_dirs: List[str], dry_run: bool = False, follow_symlinks: bool = False
) -> Tuple[int, Set[str]]:
    """
...
def main() -> None:
    ...
    parser.add_argument("directory", help="The root directory to search for empty directories")
    parser.add_argument(
        "--dry-run",
        action="store_true",
